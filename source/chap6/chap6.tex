...
\newpage\titf{Chương 6: Giải số các phương trình vi phân}
...
\item Giải hệ phương trình vi phân cấp một
%\item Bài tập
...
(ta chọn các tham số về tốc độ phát triển của thỏ và sói, các điều kiện ban đầu, rồi bấm nút ``Start Simulation'' để xem diễn biến của quần thể)
