## -*- encoding: utf-8 -*-
# This file was *autogenerated* from the file thicuoiky2-dapan-thangdiem.sagetex.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_559 = Integer(559); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_326 = Integer(326); _sage_const_0p85 = RealNumber('0.85'); _sage_const_28 = Integer(28); _sage_const_29 = Integer(29); _sage_const_285 = Integer(285); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_20 = Integer(20); _sage_const_296 = Integer(296); _sage_const_26 = Integer(26); _sage_const_0p6058 = RealNumber('0.6058'); _sage_const_24 = Integer(24); _sage_const_428 = Integer(428); _sage_const_509 = Integer(509); _sage_const_1p1 = RealNumber('1.1'); _sage_const_136 = Integer(136); _sage_const_9p81 = RealNumber('9.81'); _sage_const_89 = Integer(89); _sage_const_2p1542 = RealNumber('2.1542'); _sage_const_0p189 = RealNumber('0.189'); _sage_const_85 = Integer(85); _sage_const_1p21 = RealNumber('1.21'); _sage_const_87 = Integer(87); _sage_const_595 = Integer(595); _sage_const_0p9755 = RealNumber('0.9755'); _sage_const_27 = Integer(27); _sage_const_0p1 = RealNumber('0.1'); _sage_const_155 = Integer(155); _sage_const_0p2 = RealNumber('0.2'); _sage_const_25 = Integer(25); _sage_const_593 = Integer(593); _sage_const_1p15 = RealNumber('1.15'); _sage_const_21 = Integer(21); _sage_const_426 = Integer(426); _sage_const_158 = Integer(158); _sage_const_553 = Integer(553); _sage_const_332 = Integer(332); _sage_const_551 = Integer(551); _sage_const_330 = Integer(330); _sage_const_557 = Integer(557); _sage_const_470 = Integer(470); _sage_const_194 = Integer(194); _sage_const_0p1863 = RealNumber('0.1863'); _sage_const_1p5224 = RealNumber('1.5224'); _sage_const_468 = Integer(468); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_15 = Integer(15); _sage_const_14 = Integer(14); _sage_const_31 = Integer(31); _sage_const_30 = Integer(30); _sage_const_19 = Integer(19); _sage_const_18 = Integer(18); _sage_const_432 = Integer(432); _sage_const_50 = Integer(50); _sage_const_382 = Integer(382); _sage_const_2p8829 = RealNumber('2.8829'); _sage_const_384 = Integer(384); _sage_const_0p1929 = RealNumber('0.1929'); _sage_const_0p0039 = RealNumber('0.0039'); _sage_const_160 = Integer(160); _sage_const_507 = Integer(507); _sage_const_229 = Integer(229); _sage_const_141 = Integer(141); _sage_const_291 = Integer(291); _sage_const_225 = Integer(225); _sage_const_227 = Integer(227); _sage_const_226 = Integer(226); _sage_const_434 = Integer(434); _sage_const_304 = Integer(304)## This file (thicuoiky2-dapan-thangdiem.sagetex.sage) was *autogenerated* from thicuoiky2-dapan-thangdiem.tex with sagetex.sty version 2012/01/16 v2.3.3-69dcb0eb93de.
import sagetex
...
try:
  ...
  t,y=var('t y')
  from sage.calculus.desolvers import eulers_method
  zk1=eulers_method(y/t-_sage_const_1p1 ,tk[_sage_const_0 ],yk[_sage_const_0 ],h,tk[_sage_const_0 ]+h*(n-_sage_const_1 ),algorithm="none")
  #yk=[[j] for i,j in zk1] # Báo lỗi phía sau: lệnh latex(round(yk[i],3)) không thực hiện được (TypeError: a float is required), vì dấu [] tạo ra matrix chứ không phải list
  yk=[j for i,j in zk1]
  # Tạo table trong Latex
  tableEuler=r"\begin{tabular}{l|c|l}"
...
_st_.blockend()
try:
 _st_.inline(_sage_const_27 , tableEuler)
except:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_28 , latex(Lagrange_1.expand()))
except:
 _st_.goboom(_sage_const_553 )
try:
 _st_.inline(_sage_const_29 , tableNewton)
except:
 _st_.goboom(_sage_const_557 )
try:
 _st_.inline(_sage_const_30 , latex(round(Lagrange_1(_sage_const_1p15 ),_sage_const_3 )))
except:
...
try:
  from sage.calculus.desolvers import desolve_rk4
  t,y=var('t y')
  zk_rk4=desolve_rk4(y/t-_sage_const_1p1 ,y,ics=[_sage_const_1 ,_sage_const_1 ],end_points=_sage_const_1p21 ,step=_sage_const_0p1 ) # nếu dùng đúng 1.2 thì nó lại bỏ số đó ra
  tk_rk4=[i for i,j in zk_rk4]
  yk_rk4=[j for i,j in zk_rk4]
  # Tạo table trong Latex
  tableRK4=r"\begin{tabular}{l|c|l}"
...
_st_.blockend()
try:
 _st_.inline(_sage_const_31 , tableRK4)
except:
